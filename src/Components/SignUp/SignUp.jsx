  ...
  const handleSubmit = (e) => {
    ...
    return (
        ...
        <div className="linear absolute w-[100%] top-[2%]  pb-[10%] ">
            ...
            />
            <h1 className=" text-3xl text-black font-bold text-center mt-8 mb-12 ">Sign<span className="text-black"> Up</span></h1>
  ...
  <div className=" w-full flex-col ">
    ...
    <div className=" flex-shrink-0 w-full shadow-xl  h-auto shadow-2xl bg-base-100">
      ...
      <div className="form-control">
        ...
        <div>
          <p className="text-black mt-3  text-center ">Already a user ? go for <Link to='/login' className="text-yellow-700 font-bold ">login</Link></p>
        </div>
        <div className="form-control mt-6">
         <input type="submit" className="  font-bold cursor-pointer btn-primary py-2 rounded-lg border-none    linear bg-black text-white hover:bg-black" value="Sign Up" />
        </div>
      
        <button onClick={handleGoogle}  className="text-red mt-5     text-center hover:before:bg-red rounded-xl font-semibold  relative py-3 w-full overflow-hidden border border-black text-black  bg-white px-3 md:px-16  shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-blue-400  before:transition-all before:duration-200 before:border-none before:text-black hover:text-black hover:border-none hover:d-400 hover:before:left-0 hover:before:w-full"><span className="relative z-10 gap-2 w-max mx-auto flex items-center"><span className=''><AiOutlineGoogle></AiOutlineGoogle></span>Continue with Goggle</span></button>
        <button onClick={handleGithub}  className="text-red mt-5     text-center hover:before:bg-red rounded-xl font-semibold  relative py-3 w-full overflow-hidden border border-black text-black  bg-white px-3 md:px-16  shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-black  before:transition-all before:duration-200 hover:text-white hover:d-400 hover:before:left-0 hover:before:w-full"><span className="relative z-10 gap-2 w-max mx-auto flex items-center"><span className=''><IoLogoGithub /></span>Continue with Github</span></button>
      </form>
    </div>
  </div>
</div>
